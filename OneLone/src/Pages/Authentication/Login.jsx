...
import { successMessage, errorMessage } from "../Utils/NotificationManager"
...
const Login = () => {
    ...
    const handleSubmitData = async (e) => {
        ...
        try {
            const response = await axiosInstance.post("/api/auth/admin/login", inputs)
    ...
    return (
        <div className="flex w-[100%] h-screen font-semibold bg-gray-100 font-nunito">
              ...
              <p className="border-2 w-[100%] p-2 text-blue-600 border-blue-600 rounded-lg flex justify-center items-center gap-2"><FcGoogle /> Login with Google</p>
                    ...
                    <div className="w-[70%] grid grid-cols-1 justify-center items-center p-2 gap-5">
                        <form className="w-[100%]" onSubmit={handleSubmitData}>
                            ...
                            <div className="p-2 flex flex-col gap-2">
                                <button className="bg-blue-600 p-2 rounded-lg text-white hover:bg-blue-500">Log in</button>
                            </div>
                        </form>
                    </div>
                </div>
